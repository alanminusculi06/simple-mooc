# Generated by Django 2.0.10 on 2019-03-06 11:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courses', '0004_auto_20190213_1943'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Nome')),
                ('embedded', models.TextField(blank=True, verbose_name='Mídia embarcada')),
                ('material_file', models.FileField(blank=True, null=True, upload_to='lessons/materials')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now_add=True, verbose_name='Atualizado em')),
