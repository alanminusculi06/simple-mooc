# Generated by Django 2.0.10 on 2019-01-30 18:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'O nome de usuário é inválido.', 'invalid')], verbose_name='Nome de usuário')),
